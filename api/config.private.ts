...
export const hosts = {
    ...
    elastic_main: getEnv('ELASTIC_HOST', '10.68.2.72:9200'),
    mongoDB_main: {
        host: getEnv('MONGO_MAIN', 'mongodb://10.68.2.72:27018/andes'), // ?authSource=admin
        options: {
    ...
    mongoDB_mpi: {
        host: getEnv('MONGO_MPI', 'mongodb://10.68.2.72:27018/mpi'), // ?authSource=admin
        options: {
            reconnectTries: Number.MAX_VALUE, // Never stop trying to reconnect
            reconnectInterval: 500,
        }
    ...
    mongoDB_snomed: {
        host: getEnv('MONGO_SNOMED', 'mongodb://10.68.2.72:27018/es-edition'), // ?authSource=admin
        options: {
            reconnectTries: Number.MAX_VALUE, // Never stop trying to reconnect
            reconnectInterval: 500,
        }
    ...
    mongoDB_puco: {
        host: getEnv('MONGO_PUCO', 'mongodb://10.68.2.72:27018/padrones'),
        options: {
            reconnectTries: Number.MAX_VALUE, // Never stop trying to reconnect
...
export const logDatabase = {
    log: {
        host: getEnv('MONGO_LOGS', `mongodb://10.68.2.72:27018/andesLogs`),
        options: {
